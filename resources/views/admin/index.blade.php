                        ...
                        <tbody>
                            @foreach ($data['plans'] as $plan)
                                <tr>
                                    ...
                                    <td>{{$plan->price}}</td>
                                    <td>{{$plan->trial}}</td>
                                    <td>@include('components.admin.actions', ['model' => $plan,'name' => 'subscription-plans'])</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            @foreach ($data['subscriptions'] as $subscription)
                                <tr>
                                    ...
                                    <td>@include('components.admin.actions', ['model' => $subscription,'name' => 'subscriptions','actions' => ['show', 'destroy']])</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
