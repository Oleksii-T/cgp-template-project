...
@section('content_header')
    <x-admin.title
        text="Edit blog"
        :bcRoute="['admin.blogs.edit', $blog]"
    />
@stop

@section('content')
    <form action="{{route('admin.blogs.update', $blog)}}" method="POST" class="general-ajax-submit">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4 user-image-block">
                    <label class="uploader mr-3 show-uploaded-file-preview">
                        ...
                        <img src="{{$blog->thumbnail?->url}}" class="custom-file-preview" alt="" style="width: 400px">
                    </label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Content</label>
                            <x-admin.multi-lang-input name="content" :model="$blog" :textarea="true" />
                ...
                <div class="row">
                    ...
                    @foreach ($blog->images as $image)
                        <div class="col-md-4 image-input">
                            <div class="form-group show-uploaded-file-preview">
                                <input type="file" class="form-control" name="images[]">
                                <img src="{{$image->url}}" class="custom-file-preview" alt="" style="width: 200px">
                                <button type="button" class="btn btn-warning delete-image-input" data-url="{{route('admin.attachments.destroy', $image)}}">Remove</button>
                            </div>
                        </div>
                    @endforeach
